...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  missing_env:
    "⚠ сервер не настроен — задайте TELEGRAM_BOT_TOKEN или другой бэкенд в Cloudflare",
  ...
  telegram_error: "⚠ не удалось отправить в Telegram — проверьте BOT_TOKEN и CHAT_ID",
  telegram_unreachable: "⚠ Telegram API недоступен — попробуйте позже",
  webhook_error: "⚠ webhook не принял заявку — проверьте LEADS_WEBHOOK_URL",
  webhook_unreachable: "⚠ webhook недоступен",
  kv_error: "⚠ ошибка KV — проверьте биндинг LEADS_KV",
  d1_error: "⚠ ошибка D1 — проверьте биндинг LEADS_DB",
